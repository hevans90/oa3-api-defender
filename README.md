...
- A static Swagger UI implementation, that reads the OpenAPI yaml file in the root of this repo, and targets the mock-api by default (see mock README for info on serving)
